...
set_property -dict [list CONFIG.C_NUM_OF_PROBES {9} CONFIG.C_PROBE0_WIDTH {24} CONFIG.C_PROBE1_WIDTH {16} CONFIG.C_PROBE2_WIDTH {5} CONFIG.C_PROBE3_WIDTH {16} CONFIG.C_PROBE4_WIDTH {16} CONFIG.C_PROBE5_WIDTH {24} CONFIG.C_PROBE6_WIDTH {1} CONFIG.C_PROBE7_WIDTH {1} CONFIG.C_PROBE8_WIDTH {4}  CONFIG.Component_Name {ila_Weightcache}] [get_ips ila_Weightcache]